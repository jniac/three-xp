import { BufferGeometry, Color, Group, IcosahedronGeometry, Line, LineBasicMaterial, Points, PointsMaterial, RingGeometry, Vector4 } from 'three'
...
export class NurbsDemo extends Group {
  constructor() {
    super()
...
export class Contributions extends Group {
  constructor() {
    super()
