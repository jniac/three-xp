...
export function createRootD4(width: number, height: number) {
...
export function PositioningDemo() {
  const { ref } = useEffects<HTMLDivElement>(function* (div) {
    ...
    const d4 = createRootD4(context.width, context.height)
    yield onTick('layout', tick => {
      d4.updateOnTick(tick)
      context.paint(d4.root)
    })
  }, [])
