...
export function UI() {
  return (
    <div className={`ui layer thru p-8 flex flex-col gap-4 items-start`}>
      ...
      <p className='flex w-[400px]'>
        The problem:<br />
        Linear interpolation of matrix columns produces weird intermediate states.
      </p>

      <p className='flex w-[400px]'>
        Conclusion:<br />
        The matrices should be decomposed to position, rotation, scale, shear, interpolated, then recomposed.
      </p>
      <p className='flex w-[400px]'>
        But shear is tricky...
      </p>
