...
import { Color, DoubleSide, Group, IcosahedronGeometry, InstancedBufferAttribute, InstancedMesh, Mesh, MeshBasicMaterial, PlaneGeometry, TorusKnotGeometry } from 'three'
...
function Scene() {
  useThree(function* (three) {
    ...
    const scene = new DepthOffsetTest()
